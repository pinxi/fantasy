  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <p className="mt-3 text-[11px] text-zinc-600">
        ros pts = sum of weekly optimal-lineup projections (our league-conditional numbers) · playoff wks = weeks 15–17 ·
        market $ = fantasycalc roster total · position columns = ROS lineup points from that position (green = league best) ·
        click a team for detail, history + head-to-head
      </p>
    </div>
  );
}
